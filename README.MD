...
<mark>Don't forget to change the save path of the created wav file in MorseWav.cpp its constructors first line,<br> at filename=&quot;string filename = "C:\\Users\\User\\Desktop\\wav-files-morse&quot;</mark> or else no wav will be created.<br><br>
